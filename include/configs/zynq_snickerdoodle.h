 ...
 *
 * Configuration for snickerdoodle Zynq Development Board
...
#define CONFIG_EXTRA_ENV_SETTINGS	\
	...
	"qspiboot=echo Copying Linux from QSPI flash to RAM... && " \
		"sf probe && " \
		"sf read ${kernel_load_address} 0x80000 ${kernel_size} && " \
		"sf read ${devicetree_load_address} 0x480000 ${devicetree_size} && " \
		"echo Copying ramdisk... && " \
		"sf read ${ramdisk_load_address} 0x490000 ${ramdisk_size} && " \
		"bootm ${kernel_load_address} ${ramdisk_load_address} ${devicetree_load_address}\0" \
	"uenvboot=" \
